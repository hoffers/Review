...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    // README - simplified loop by taking variable out of it (change 02)
...
// simplified loop by taking variable out of it.
...
function logAverageFrame(times) {   // times is the array of User Timing measurements from updatePositions()
  ...
  var sum = 0;
  // README: cached 'numberOfEntries - 11' (change 01)
...
function updatePositions() {
   ...
   // README - get the browser window height (change 07)
   ...
   // README: cached document.body.scrollTop and calculation (change 05)
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < numberOfPizzas; i++) {
     ...
     // README - adding img size (change 08)
     elem.width = 73;
     elem.height = 100;

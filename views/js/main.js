...
var adjectives = ["dark","morbid", "scary", "spooky", "gothic", "deviant", "creepy", "sadistic", "black", "dangerous", "dejected", "haunted", 
      ...
      "brainwashed", "sapphire", "opal", "silver", "gold", "platinum", "ruby", "emerald", "topaz", "diamond", "amethyst", "turquoise", 
      "starlit", "moonlit", "bronze", "metal", "jade", "amber", "garnet", "obsidian", "onyx", "pearl", "copper", "sunlit", "brass", "brassy",
      "metallic", "untuned", "loud", "soft", "shrieking", "melodious", "musical", "operatic", "symphonic", "dancing", "lyrical", "harmonic", 
      ...
      "humming", "scatting", "whispered", "whispering", "rasping", "buzzing", "whirring", "whistling", "whistled", "nuclear", "apocalyptic", 
      "desolate", "atomic", "zombie", "collapsed", "grim", "fallen", "collapsed", "cannibalistic", 
      "radioactive", "toxic", "poisonous", "venomous", "disastrous", "grimy", "dirty", "undead", "bloodshot", "rusty", "glowing", "decaying",
      "rotten", "deadly", "plagued", "decimated", "rotting", "putrid", "decayed", "deserted", "acidic", "stupid", "idiotic", "fat", "ugly", 
      "hideous", "grotesque", "dull", "dumb", "lazy", "sluggish", "brainless", "slow", 
      ...
      "horrible", "syncophantic", "unhelpful", "bootlicking", "beautiful", "intelligent", "smart", "genius", "ingenious", "gorgeous", "pretty", "witty", "angelic", "handsome", "graceful",
      ...
      "majestic", "grand", "stunning", "scientific", "technical", "digital", "programming", "calculating", "formulating", "cyberpunk", "mechanical", "technological", 
      "innovative", "brainy", "chemical", "quantum", "astro", "space", "theoretical", "atomic", "electronic", "gaseous", "investigative", "solar", 
      "extinct", "galactic"];  

var nouns = ["flamingo", "hedgehog", "owl", "elephant", "pussycat", "alligator", "dachsund", "poodle", "beagle", "crocodile", "kangaroo", 
      ...
      "garden", "school", "wallet", "bottle", "centaur", "wizard", "gnome", "orc", "troll", "sword", "fairy", "pegasus", "halfling", "elf", "changeling", "ghost", 
      "knight", "squire", "magician", "witch", "warlock", "unicorn", "dragon", "wyvern", "princess", "prince", "king", "queen", "jester", 
      "tower", "castle", "kraken", "seamonster", "mermaid", "psychic", "seer", "oracle", "slime", "bug", "roach", "fluid", "pus", "booger", 
      ...
      "fluid", "moisture", "garbage", "trash", "bug", "murderer", "chainsaw", "knife", "sword", "murder", "devil", "killer", "psycho", "ghost", "monster", "godzilla", "werewolf", 
      ...
      "fiend", "satanist", "moon", "fullMoon", "earrings", "ring", "necklace", "pendant", "choker", "brooch", "bracelet", "cameo", "charm", "bauble", "trinket", "jewelry", 
      "anklet", "bangle", "locket", "finery", "crown", "tiara", "blingBling", "chain", "rosary", "jewel", "gemstone", "beads", "armband", "pin",
      "costume", "ornament", "treasure", "swamp", "graveyard", "cemetery", "park", "building", "house", "river", "ocean", "sea", "field", "forest", "woods", "neighborhood",
      "city", "town", "suburb", "country", "meadow", "cliffs", "lake", "stream", "creek", "school", "college", "university", "library", "bakery",
      "shop", "store", "theater", "garden", "canyon", "highway", "restaurant", "cafe", "diner", "street", "road", "freeway", "alley", "robot", 
      "alien", "raygun", "spaceship", "UFO", "rocket", "phaser", "astronaut", "spaceman", "planet", "star", "galaxy", 
...
var makeRandomPizza = function() {
  ...
  for (var i = 0; i < numberOfMeats; i++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.meats[Math.floor((Math.random() * pizzaMeatsLength))]);
  }

  for (var j = 0; j < numberOfNonMeats; j++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.nonMeats[Math.floor((Math.random() * pizzaNonMeatsLength))]);
  }

  for (var k = 0; k < numberOfCheeses; k++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.cheeses[Math.floor((Math.random() * pizzaCheesesLength))]);
  }

  pizza = pizza + ingredientItemizer(pizzaIngredients.sauces[Math.floor((Math.random() * pizzaSaucesLength))]);
  pizza = pizza + ingredientItemizer(pizzaIngredients.crusts[Math.floor((Math.random() * pizzaCrustsLength))]);
...
var resizePizzas = function(size) { 
  ...
  //UPDATED: new size calculated once
...
//Checks if element is in viewport. From: http://stackoverflow.com/a/7557433/1709587
...
// UPDATED: only moves those visible on viewport
